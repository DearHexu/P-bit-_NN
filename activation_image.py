"""
Plot images of various activation functions
Includes: Sigmoid, ReLU, SiLU (Swish), Tanh, Leaky ReLU, GELU, etc.
"""
...
def gumbel_sigmoid(logits, temperature=1.0, hard=True, rng=None):
    ...
    return y_hard  # Forward value is the hard sampling result


def plot_activation(ax, x, y, name, color='#2E86AB'):
    """Plot a single activation function on a subplot"""
...
def main():
    ...
    print('Image saved as activation_functions.png')
    plt.show()
